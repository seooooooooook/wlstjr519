...
(function(e, t, r) {
        ...
        function n(r) {
            ...
            ft && (Vt = r.scale || 1),
                ...
                Gt ? (st = t.getElementById("skrollr-body"),
                st && at(),
                    X(),
        ...
        n.prototype.refresh = function(e) {
                                ...
                                if ("data-edge-strategy" !== g.name)
                                    if ("data-emit-events" !== g.name) {
                                        ...
                                        if (null !== v) {
                                            ...
                                            var b = v[3]
                                                , S = v[4] || b;
                                            b && b !== A && b !== F ? (h.mode = "relative",
                                                h.anchors = [b, S]) : (h.mode = "absolute",
                                                b === F ? h.isEnd = !0 : h.isPercentage || (h.offset = h.offset * Vt))
                                        }
                                    } else
                                        u = !0;
                                else
            ...
            n.prototype.animateTo = function(e, t) {
                ...
                pt.topDiff || (pt.done && pt.done.call(it, !1),
                    pt = r),
                    it
            }
            ,
        ...
        var X = function() {
            ...
            for (var r = 0, n = lt.length; n > r; r++) {
                ...
                if (T || b) {
                    if (T && -1 === s.edge || b && 1 === s.edge)
                        continue;
                    switch (T ? (Dt(c, [g], [h, v]),
                    k && w > -1 && (xt(c, p.eventType, zt),
                        s.lastFrameIndex = -1)) : (Dt(c, [h], [g, v]),
                    k && m > w && (xt(c, y.eventType, zt),
                        s.lastFrameIndex = m)),
                        s.edge = T ? -1 : 1,
                        s.edgeStrategy) {
                        case "reset":
                ...
                for (var E = 0; m - 1 > E; E++)
                    if (f >= u[E].frame && u[E + 1].frame >= f) {
                        ...
                        k && w !== E && ("down" === zt ? xt(c, A.eventType, zt) : xt(c, F.eventType, zt),
                            s.lastFrameIndex = E);
                        break
                    }
            }
            ...
            if (pt)
                o >= pt.endTime ? (n = pt.targetTop,
                    e = pt.done,
                    pt = r) : (t = pt.easing((o - pt.startTime) / pt.duration),
                ...
                vt.endTime >= o && (t = U.sqrt((o - vt.startTime) / gt),
                    n = 0 | vt.startTop + t * vt.topDiff)
            }
            if (Gt && st && i.setStyle(st, "transform", "translate(0, " + -Kt + "px) " + Tt),
            ht || qt !== n) {
